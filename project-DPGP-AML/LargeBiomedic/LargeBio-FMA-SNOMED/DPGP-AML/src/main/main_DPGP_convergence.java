...
public class main_DPGP_convergence {
    public static void main(String[] args) throws Exception {
        ...
        String path="D:\\文件\\收敛实验\\LargeBio-FMA-SNOMED-DPGP-0.3.xlsx";

        for (int z = 0; z < 4; z++) {
            if (z == 1) {
                errorRate = 0.2;
                path = "D:\\文件\\收敛实验\\LargeBio-FMA-SNOMED-DPGP-0.2.xlsx";
            }
            if (z == 2) {
                errorRate = 0.1;
                path = "D:\\文件\\收敛实验\\LargeBio-FMA-SNOMED-DPGP-0.1.xlsx";
            }
            if (z == 3) {
                errorRate = 0;
                path = "D:\\文件\\收敛实验\\LargeBio-FMA-SNOMED-DPGP-0.xlsx";
            }

            System.out.println("第" + (z + 1) + "次测试...");
            List<List<List<String>>> clusters = definedMatrix.readMappedThreeList(definedMatrix.clusters_FMA_SNOMED);
