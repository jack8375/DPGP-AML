...
public class ekaw_iasted {
    public static void main(String[] args) throws Exception {
        ...
        String s3 = "D:\\conference\\DPGP-AML\\reference-alignment\\ekaw-iasted.rdf";
        ...
        alignment.add("presenter---presenter_city");
        alignment.add("session---session");
        alignment.add("student---student_lecturer");
        alignment.add("research_institute---research");
        alignment.add("university---presenter_university");
        alignment.add("conference_paper---conference_days");
        alignment.add("conference_paper---conference_hall");
        alignment.add("conference_paper---conference_city");
        ...
        alignment.add("session_chair---session_chair");
        alignment.add("tutorial_abstract---tutorial");
        alignment.add("research_topic---research");
        alignment.add("poster_session---session");
        alignment.add("conference_session---conference_state");
        alignment.add("tutorial---tutorial");
        alignment.add("conference_proceedings---conference_building");
        alignment.add("individual_presentation---video_presentation");
        alignment.add("conference_trip---conference_days");
        alignment.add("conference_trip---conference_hall");
        alignment.add("conference_trip---conference_city");
        alignment.add("demo_session---session");
        alignment.add("tutorial_chair---tutorial");
        alignment.add("proceedings---book_proceeding");
        ...
        tempAlignment.add("poster_session---session");
        tempAlignment.add("demo_session---session");
        for (int i = 0; i < alignment.size(); i++) {
            for (int j = 0; j < tempAlignment.size(); j++) {
                if (alignment.get(i).equals(tempAlignment.get(j))) {
                    alignment.remove(i);
