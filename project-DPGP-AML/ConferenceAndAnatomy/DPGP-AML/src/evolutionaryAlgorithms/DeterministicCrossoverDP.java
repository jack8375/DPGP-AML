...
public class DeterministicCrossoverDP implements Serializable{
    ...
    public static List<ArrayList<LinkedTreeNode>> deterministicCrossover(List<ArrayList<LinkedTreeNode>> populationBetter, int selectionSize, List<String> PSA,
                                                                         List<List<String>> source, List<List<String>> target, double crossoverProbability) throws IOException {
    ...
    public static double semSim(ArrayList<LinkedTreeNode> ind1, ArrayList<LinkedTreeNode> ind2, List<List<String>> source, List<List<String>> target) throws IOException {
        List<double[][]> binaryAndSimilarityMatrix1 = decode.decodeBT(ind1);
        double[][] binaryMatrix1 = binaryAndSimilarityMatrix1.get(0);
        List<double[][]> binaryAndSimilarityMatrix2 = decode.decodeBT(ind2);
