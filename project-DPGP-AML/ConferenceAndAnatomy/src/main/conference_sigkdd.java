...
public class conference_sigkdd {
    public static void main(String[] args) throws Exception {
        ...
        String s3 = "D:\\conference\\DPGP-AML\\reference-alignment\\conference-sigkdd.rdf";
        ...
        alignment.add("organizing_committee---organizing_committee");
        alignment.add("regular_author---author");
        alignment.add("invited_speaker---invited_speaker");
        alignment.add("program_committee---program_committee");
        alignment.add("extended_abstract---abstract");
        alignment.add("committee---committee");
        ...
        //alignment.add("has_an_email---e-mail");
