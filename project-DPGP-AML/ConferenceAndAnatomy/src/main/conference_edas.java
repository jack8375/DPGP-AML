...
public class conference_edas {
    public static void main(String[] args) throws Exception {
        ...
        String s3 = "D:\\conference\\DPGP-AML\\reference-alignment\\conference-edas.rdf";
        ...
        alignment.add("conference_document---conferenceevent");
        alignment.add("conference_volume---conference");
        alignment.add("call_for_paper---callforpapers");
        alignment.add("call_for_paper---call");
        alignment.add("review---reviewform");
        alignment.add("review---reviewer");
        alignment.add("review---review");
        alignment.add("review---reviewrating");
        alignment.add("conference_www---conference");
        alignment.add("conference_fees---conference");
        alignment.add("organization---organizationalmeeting");
        alignment.add("organization---organization");
        alignment.add("conference---conferencesession");
        alignment.add("conference---conferencechair");
        alignment.add("conference---conference");
        alignment.add("conference---conferencevenueplace");
        alignment.add("conference---conferenceevent");
        alignment.add("conference---conferencedinner");
        alignment.add("topic---topic");
        alignment.add("presentation---paperpresentation");
        ...
        alignment.add("paper---paper");
        alignment.add("conference_part---conferenceevent");
        alignment.add("conference_applicant---conferencechair");
        alignment.add("conference_document---document");
        alignment.add("conference_volume---conference");
        alignment.add("review---review");
        alignment.add("organization---organization");
        ...
        for (int i = 0; i < alignment.size(); i++) {
            String[] strs = splitString1(alignment.get(i));
            List<String> list = property.propertyMappings(strs[0], strs[1], source2, target2, source3, target3, 0.9);
