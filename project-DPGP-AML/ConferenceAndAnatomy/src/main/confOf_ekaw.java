...
public class confOf_ekaw {
    public static void main(String[] args) throws Exception {
        ...
        String s3 = "D:\\conference\\DPGP-AML\\reference-alignment\\confOf-ekaw.rdf";
        ...
        alignment.add("student---student");
        alignment.add("conference---conference");
        alignment.add("camera_ready_event---event");
        alignment.add("person---person");
        alignment.add("member_pc---oc_member");
        alignment.add("member_pc---sc_member");
        alignment.add("member_pc---pc_member");
        alignment.add("tutorial---tutorial");
        alignment.add("chair_pc---oc_chair");
        alignment.add("chair_pc---pc_chair");
        alignment.add("short_paper---paper_author");
        alignment.add("banquet---conference_banquet");
        alignment.add("university---university");
        alignment.add("trip---conference_trip");
        ...
        alignment.add("participant---conference_participant");
        alignment.add("regular---regular_session");
        alignment.add("poster---poster_paper");
        alignment.add("event---event");
        alignment.add("topic---research_topic");
        alignment.add("member---agency_staff_member");
        alignment.add("social_event---social_event");
        alignment.add("working_event---event");
            ...
            if (WaysOfSimilarity.SMOASimilarity(strs[0], strs[1]) == 1) {
                ...
                for (int j = 0; j < alignment.size(); j++) {
                    ...
                    if (WaysOfSimilarity.SMOASimilarity(align[0], align[1]) != 1) {
                        ...
                        else newAlignment.add(alignment.get(j));
                    }
                }
            }
        }
        ...
        tempAlignment.add("member_pc---oc_member");
        tempAlignment.add("member_pc---sc_member");
        tempAlignment.add("chair_pc---oc_chair");
        tempAlignment.add("member---sc_member");
        tempAlignment.add("member---pc_member");
        tempAlignment.add("working_event---event");
        //tempAlignment.add("member---oc_member");
